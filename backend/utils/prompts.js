const questionAnswerPrompt = (role, experience, topicToFocus, numberOfQuestions) => (
    ...
    - If the answer needs a code example, add a small code blocak inside. 
...
const conceptExplainPrompt = (question) => (`
    ...
    - Question: "${question}" 
    - After the explanation, provide a short and clear title that summarizes the concept for the concept for the article or page header. 
